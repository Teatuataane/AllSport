...
// answering it. Forwards to Tane via ImprovMX (MX + SPF on allsport.nz).
...
const competitionData: Row[] = [
  ...
  },
  {
    ...
    why: 'Workouts you, your parent or a kaiwhakawā log between games: the day, what you did and how much. Your best efforts count toward your colours, and the amount you train is shown back to you as training units.',
