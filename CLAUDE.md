...
*Last updated: June 2026 (session 15 — Felix division fix, PR loading via bulk query, effort task UI + Power throws rule; new events: Foot Juggling, Ultimate Frisbee, Rats & Rabbits, Speed Chess; Handball removed; domain pools uncapped)*
