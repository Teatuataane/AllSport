-- AllSport Phase 2 Migration
-- Features: difficulty tiers, disadvantage system, updated award_session_points trigger
-- Run this in the Supabase SQL editor (Dashboard > SQL Editor > New query)

-- ============================================================
-- 1. New columns on results
-- ============================================================

ALTER TABLE results ADD COLUMN IF NOT EXISTS difficulty_tier TEXT;
ALTER TABLE results ADD COLUMN IF NOT EXISTS disadvantage_type TEXT;   -- 'small', 'large', or null
ALTER TABLE results ADD COLUMN IF NOT EXISTS disadvantage_option TEXT; -- which of the three options chosen

-- ============================================================
-- 2. Updated award_session_points trigger
-- Now includes players with no score for an event as last
-- place for that event when computing placements.
-- ============================================================
