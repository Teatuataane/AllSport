...
export const EVENTS: EventData[] = [
  ...
  },
  {
    ...
    hasDifficultyTiers: true,
    difficultyTiers: [
      { level: 1, name: '¼ BW — 200m', detail: 'A quarter of your bodyweight, taken from the middle of your band. Carry the heaviest load we own at or under it' },
  ...
  {
    slug: 'wheelbarrow-push',
    name: 'Wheelbarrow Push',
    domain: 'Aerobic Endurance',
    domainNumber: 6,
    inputMode: 'difficulty+time',
    hasDifficultyTiers: true,
    difficultyTiers: [
      { level: 1, name: '¼ BW — 200m', detail: 'A quarter of your bodyweight in the barrow, taken from the middle of your band. Load the heaviest weight we own at or under it' },
      { level: 2, name: '½ BW — 200m' },
      { level: 3, name: '¾ BW — 200m' },
      { level: 4, name: 'Bodyweight — 200m' },
    ],
