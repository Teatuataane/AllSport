...
export const EVENTS: EventData[] = [
  ...
  },
  {
    ...
    rules: "Declare your tier before starting. Chest touches the floor every rep; full elbow lockout at the top; hips stay in line — no sagging or piking. Resting is allowed in the top position only. Two minutes on the clock: most reps at your tier inside two minutes wins, and a higher tier always outranks a lower one.",
  ...
  },
  {
    ...
    // plantarflexion not at all. Reps rather than load, to sit in the domain.
    slug: 'calf-raises',
    name: 'Calf Raises',
    domain: 'Anaerobic Endurance',
    domainNumber: 5,
    ...
    hasDifficultyTiers: true,
    difficultyTiers: [
      { level: 1, name: 'Two-Leg Raise', detail: 'Both feet flat on the floor, rising to the top of the toes' },
      { level: 2, name: 'Two-Leg Deficit', detail: 'Both feet on a step, heels dropping below the toes each rep' },
      { level: 3, name: 'Single-Leg Raise', detail: 'One foot on the floor, the other held clear' },
      { level: 4, name: 'Single-Leg Deficit', detail: 'One foot on a step, heel dropping below the toes each rep' },
    ],
    howToPerform: "Stand tall with the ball of the foot loaded, on the floor or on the edge of a step as your tier calls for. Drive up onto the toes as high as you can, pause at the top, then lower all the way down under control. Keep the knee straight throughout.",
    rules: "Declare your tier before starting. Every rep goes to full height at the top and, on a deficit tier, a full stretch at the bottom — a part rep does not count. Knees stay straight; bending them to bounce ends the set. One hand may rest on a wall for balance but must not take weight. Most reps at your tier wins; a higher tier always outranks a lower one.",
    videoPlaceholder: true,
    emoji: '🦵',
  },
  ...
  },
  {
    ...
    rules: "Format and scoring set by the kaiwhakawā before play and kept the same for all matches. Log your result as a win, draw, or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Elbow stays on the pad for the whole match — lifting it is a foul. Shoulders square to the table and the free hand stays on the peg. A pin is the back of the hand touching the pad. Two fouls lose the match. Log your result as a win, draw or loss with your opponent's name. Every match you play earns a training unit toward your colours. Drill: hold your forearm at 45 degrees from the table against the load, the last moment before a pin, for time. Longest hold at your load wins, and a heavier load outranks a lighter one. Any game outranks every drill.",
    videoPlaceholder: true,
    emoji: '💪',
  },
  {
  ...
  },
  {
    ...
    hasDifficultyTiers: true,
    difficultyTiers: [
      { level: 1, name: 'Fingers Forward', detail: 'Palms flat on the floor, fingers pointing away, elbows soft' },
      { level: 2, name: 'Elbows Locked', detail: 'Palms flat, fingers pointing away, arms straight, weight over the hands' },
      { level: 3, name: 'Fingers Turned In', detail: 'Palms flat, fingers pointing back toward the knees, arms straight' },
      { level: 4, name: 'Fingers In · Loaded', detail: 'Fingers pointing back with the hips stacked over the hands' },
    ],
    howToPerform: "Kneel and place your palms flat on the floor in the direction your tier calls for. Straighten your arms and shift your weight over your hands until you feel the stretch through the front of the forearm. Hold.",
    rules: "Declare your tier before starting. The whole palm and every fingertip stay in contact with the floor — the hold ends the moment the heel of a hand lifts. On Elbows Locked and above the arms stay straight. Longest hold at your tier wins; a higher tier always outranks a lower one.",
    videoPlaceholder: true,
    emoji: '🖐️',
  },
  {
    ...
    rules: "Declare your tier before starting. The back of each hand and every knuckle stay in contact with the floor — the hold ends the moment a hand rolls up onto its edge. On Backs Down · Straight and above the arms stay straight. Ease into this one: the wrist has far less range this way than palms-down. Longest hold at your tier wins; a higher tier always outranks a lower one.",
    videoPlaceholder: true,
    emoji: '✋',
  },
  ...
  },
  {
    ...
    rules: "Grid size, round length, and rounds per match are set by the kaiwhakawā and kept the same for all matches. Tags must be a clear touch — no pushing or grabbing. Log your result as a win, draw, or loss with your opponent's name. Every match you play earns a training unit toward your colours. Drill (Grid Dodge): in a 10m grid, touch six cones the kaiwhakawā calls at random, for time. Fastest wins. Any game outranks every drill.",
  ...
  },
  {
    ...
    rules: "Run head-to-head on matching courses. Touch each cone as set by the kaiwhakawā; a missed cone means going back to it. No crossing into the other lane. Log your result as a win or loss with your opponent's name. Every race you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Format (team size, touches per set, game length) is set by the kaiwhakawā and kept the same for all matches. Standard touch rules: six touches, no kicking, forward passes are turnovers. Log your result as a win, draw, or loss. Every match you play earns a training unit toward your colours.",
...

  {
    ...
    rules: "Format, field size and down rules are set by the kaiwhakawa and matched for all players. Log your result as a win, draw or loss with your opponent's name. Must be witnessed by a judge. Every game you play earns a training unit toward your colours.",
    videoPlaceholder: true,
    emoji: '🏈',
  },
  {
    ...
    rules: "A tag in the opponent's half sends you to jail; you are safe in your own half. A jailed player is freed by a teammate's touch. The round is won by carrying the enemy flag over the halfway line. Field size, team size and round length are set by the kaiwhakawa and matched for all players. Log your result as a win, draw or loss. Every round you play earns a training unit toward your colours. Drill (Flag Run): sprint 20m to the flag, pick it up and carry it back over halfway, for time. Fastest wins. Any game outranks every drill.",
    videoPlaceholder: true,
    emoji: '🚩',
  },
  {
...

  {
    ...
    rules: "Light contact only — control is the standard, and the kaiwhakawā stops the match at any excessive contact. Round length and scoring zones set on the day. Protective gear worn where available. Log your result as a win, draw, or loss. Every match you play earns a training unit toward your colours. Drill (Target Kick): kicks landed on a held pad out of ten, at waist, chest or head height. Most landed wins, and a higher target outranks a lower one. Any game outranks every drill.",
  ...
  },
  {
    ...
    rules: "Match length and scoring set by the kaiwhakawā. No strikes, no submissions, no slams — takedowns must be controlled to the mat. Log your result as a win, draw, or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Bout format and target touches set by the kaiwhakawā. Masks and chest protection required; only the equipment provided may be used. Clean, controlled touches only. Log your result as a win or loss with your opponent's name. Every bout you play earns a training unit toward your colours. Drill (Target Lunge): hits on a target out of ten, lunging from 2, 3 or 4 metres. Most hits wins, and a longer lunge outranks a shorter one. Any game outranks every drill.",
  ...
  },
  {
    ...
    rules: "First to the target points, set by the kaiwhakawā. No hands or arms; maximum three touches per side and no consecutive touches with the same body part. Log your result as a win or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Format (games or first-to points, serve rules) set by the kaiwhakawā and kept the same for all matches. Log your result as a win, draw, or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Format set by the kaiwhakawā: overs per side, runs and dismissal rules, kept the same for all matches. Log your result as a win, draw, or loss. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "First to the target points (rally scoring), set by the kaiwhakawā. Standard badminton faults apply: shuttle must cross the net and land in, no double hits. Log your result as a win or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Format (target score, 1s-and-2s scoring, game length) set by the kaiwhakawā and kept the same for all matches. Standard violations apply — travels, double dribble, and fouls called honestly. Log your result as a win or loss. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Format (team size, goal size, game length) set by the kaiwhakawā and kept the same for all matches. No slide tackles. Log your result as a win, draw, or loss. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Format set by the kaiwhakawā and kept the same for all matches. Sticks below shoulder height at all times; no lifting the ball dangerously. Log your result as a win, draw, or loss. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "First to the target points, set by the kaiwhakawā. Standard squash rules: ball above the tin and below the out line, one bounce. Play lets and strokes honestly. Log your result as a win or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
...

  {
    ...
    rules: "Format, field size and rules are set by the kaiwhakawa and matched for all players. Log your result as a win, draw or loss with your opponent's name. Must be witnessed by a judge. Every game you play earns a training unit toward your colours.",
    videoPlaceholder: true,
    emoji: '🥍',
  },
  {
  ...
  // ─── Domain 10: Aim & Precision ──────────────────────────────────────────────
  {
    ...
    rules: "Format set by the kaiwhakawā (shooting rounds or a timed small-sided game) and kept the same for all matches. Standard netball rules where playing a game: no stepping, no contact, obstruction at arm's length. Log your result as a win, draw, or loss. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Points per end go to the balls closer to the jack than the opponent's best ball; first to the target score set by the kaiwhakawā. Throw from behind the line. Log your result as a win or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
    videoPlaceholder: true,
    emoji: '🎯',
  },
  {
    ...
    rules: "Format (team size, sets, court size) set by the kaiwhakawā. Hits above the shoulders don't count and headhunting is a foul. A caught ball puts the thrower out. Honesty rule: call yourself out. Log your result as a win, draw, or loss. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Standard carrom rules: strike from your own baseline, pocket your pieces, and the queen must be covered to count. Fouls return a pocketed piece to the board. First to clear their pieces (with the queen resolved) wins. Log your result as a win or loss. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Distance, arrows per end, and total ends are set by the kaiwhakawā and matched for both players. All safety commands are absolute — arrows are only nocked on the shooting line and collected together. Highest total wins the match. Log your result as a win, draw, or loss. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Game format (301/501, straight or double finish) set by the kaiwhakawā and matched for all players. Both feet behind the oche when throwing. Log your result as a win or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
  ...
  },
  {
    ...
    rules: "Play the 4 holes set out by the kaiwhakawā, from the tees and to the targets marked. Every throw counts one stroke; play the disc where it lies, with course penalty rules as set on the day. Lowest total strokes wins. Every 4-hole round earns a training unit toward your colours. In a game, fewer strokes than your opponent is a win and equal strokes is a draw.",
    videoPlaceholder: true,
    emoji: '🥏',
  },
  {
    ...
    rules: "Play the 4 holes set out by the kaiwhakawā from the marked tees. Every stroke counts, penalties as set on the day, and the ball is holed when it is in the cup (or hits the marked target). Lowest total strokes wins. Every 4-hole round earns a training unit toward your colours. In a game, fewer strokes than your opponent is a win and equal strokes is a draw.",
    videoPlaceholder: true,
    emoji: '⛳',
  },
  {
    ...
    rules: "Format and court are set by the kaiwhakawa and matched for all players. No travelling with the ball beyond the allowed steps. Log your result as a win, draw or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
    videoPlaceholder: true,
    emoji: '🤾',
  },
  {
    ...
    rules: "Game and match format (points per game, best-of) set by the kaiwhakawa and matched for all players. Standard service and let rules apply. Log your result as a win or loss with your opponent's name. Every match you play earns a training unit toward your colours.",
    videoPlaceholder: true,
    emoji: '🏓',
  },
  {
    ...
    rules: "Underarm, end-over-end baton throws only — no helicopter throws. Standard kubb sequence: field kubbs must fall before baseline kubbs, king last. Toppling the king before clearing everything else is an instant loss. Log your result as a win or loss. Every match you play earns a training unit toward your colours.",
    videoPlaceholder: true,
    emoji: '🪵',
  },
]
