...
export const EVENTS: EventData[] = [
  ...
  },
  {
    ...
    rules: "Elbow stays on the pad for the whole match — lifting it is a foul. Shoulders square to the table and the free hand stays on the peg. A pin is the back of the hand touching the pad. Two fouls lose the match. Log your result as a win, draw or loss with your opponent's name. Extra matches vs new opponents earn effort points. Drill: hold your forearm at 45 degrees from the table against the load, the last moment before a pin, for time. Longest hold at your load wins, and a heavier load outranks a lighter one. Any game outranks every drill.",
    videoPlaceholder: true,
    emoji: '💪',
  },
  {
  ...
  },
  {
    ...
    rules: "Grid size, round length, and rounds per match are set by the kaiwhakawā and kept the same for all matches. Tags must be a clear touch — no pushing or grabbing. Log your result as a win, draw, or loss with your opponent's name. Extra matches vs new opponents earn effort points. Drill (Grid Dodge): in a 10m grid, touch six cones the kaiwhakawā calls at random, for time. Fastest wins. Any game outranks every drill.",
  ...
  },
  {
    ...
    rules: "A tag in the opponent's half sends you to jail; you are safe in your own half. A jailed player is freed by a teammate's touch. The round is won by carrying the enemy flag over the halfway line. Field size, team size and round length are set by the kaiwhakawa and matched for all players. Log your result as a win, draw or loss. Extra rounds vs new opposition earn effort points. Drill (Flag Run): sprint 20m to the flag, pick it up and carry it back over halfway, for time. Fastest wins. Any game outranks every drill.",
    videoPlaceholder: true,
    emoji: '🚩',
  },
  {
  ...
  // ─── Domain 8: Body Awareness ─────────────────────────────────────────────────
  {
    ...
    rules: "Light contact only — control is the standard, and the kaiwhakawā stops the match at any excessive contact. Round length and scoring zones set on the day. Protective gear worn where available. Log your result as a win, draw, or loss. Extra matches vs new opponents earn effort points. Drill (Target Kick): kicks landed on a held pad out of ten, at waist, chest or head height. Most landed wins, and a higher target outranks a lower one. Any game outranks every drill.",
  ...
  },
  {
    ...
    rules: "Bout format and target touches set by the kaiwhakawā. Masks and chest protection required; only the equipment provided may be used. Clean, controlled touches only. Log your result as a win or loss with your opponent's name. Extra bouts vs new opponents earn effort points. Drill (Target Lunge): hits on a target out of ten, lunging from 2, 3 or 4 metres. Most hits wins, and a longer lunge outranks a shorter one. Any game outranks every drill.",
  ...
  },
  {
    ...
    rules: "Play the 4 holes set out by the kaiwhakawā, from the tees and to the targets marked. Every throw counts one stroke; play the disc where it lies, with course penalty rules as set on the day. Lowest total strokes wins. Each additional 4-hole round earns effort points. In a game, fewer strokes than your opponent is a win and equal strokes is a draw.",
    videoPlaceholder: true,
    emoji: '🥏',
  },
  {
    ...
    rules: "Play the 4 holes set out by the kaiwhakawā from the marked tees. Every stroke counts, penalties as set on the day, and the ball is holed when it is in the cup (or hits the marked target). Lowest total strokes wins. Each additional 4-hole round earns effort points. In a game, fewer strokes than your opponent is a win and equal strokes is a draw.",
    videoPlaceholder: true,
    emoji: '⛳',
  },
  {
